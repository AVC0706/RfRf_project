            ...
            <Row>
                ...
                <Col span={20} style={{backgroundColor: '#fcac44', height: '100vh'}}>
                    <div>
                        ...
                        > {userContext.user.admin === "district" || userContext.user.admin === "state" || userContext.user.admin === "city" ?
                            <Row>
                            ...
                            {(userContext.user.admin === 'district' && mandal.districtApproved === false) || (userContext.user.admin === 'city' && mandal.cityApproved === false) ?
                                <Row>
                                    <Card>
                            ...
                            <Tabs>
                                ...
                                {mandal.districtApproved === true ? (<><TabPane tab="Meeting Information"
                                                                                key="meetingInfo">
                                    <Card>
